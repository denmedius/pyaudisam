...
Here's also the "complete" HTML [2-sample extract of this report](https://sylbor63.pagesperso-orange.fr/ds/pyaudisam/docs/how-it-works/preanlys/ACDC2019-Nat-preanalyses-report.html) ([this file in GitHub repo](./preanlys/ACDC2019-Nat-preanalyses-report.html)).
